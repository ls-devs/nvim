...
local options = {
	...
	concealcursor = "nc", -- apply concealment in normal and command modes (visual: cursor line shows raw text, rest stays rendered)
	linebreak = true,
	breakindent = true,
	breakindentopt = { "shift:2" }, -- indent wrapped lines by 2 extra spaces
	showbreak = "", -- no prefix on wrapped continuation lines
	fileencoding = "utf-8",
	hlsearch = true,
	ignorecase = true,
	mouse = "a",
	...
	confirm = false, -- don't prompt on unsaved changes when quitting
