	...
	config = function()
		require("catppuccin").setup({
			...
			integrations = {
				...
				fidget = true,
				window_picker = true,
				-- semantic_tokens: loaded unconditionally from core pipeline, not an integration key
				lsp_saga = true,
				mason = true,
				...
				neotree = true,
				gitsigns = true,
				-- treesitter: loaded unconditionally from core pipeline, not an integration key
