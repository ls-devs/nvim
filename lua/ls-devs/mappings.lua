...
keymap("n", "<leader>wrn", "<cmd>Lspsaga rename ++project<CR>", opts)
...
keymap("n", "<leader>cw", "<cmd>Lspsaga show_workspace_diagnostics<CR>", opts)
...
keymap("t", "<leader>t", "<cmd>Lspsaga term_toggle<CR>", opts)
